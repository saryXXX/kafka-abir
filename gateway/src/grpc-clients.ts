...
const loadProto = (protoName: string) => {
...
const restaurantProto = loadProto('restaurant.proto') as any;
const orderProto = loadProto('order.proto') as any;
const deliveryProto = loadProto('delivery.proto') as any;
...
// Initialize clients
export const restaurantClient = new restaurantProto.restaurant.RestaurantService(
  RESTAURANT_SERVICE_ADDR,
...
export const deliveryClient = new deliveryProto.delivery.DeliveryService(
  DELIVERY_SERVICE_ADDR,
  grpc.credentials.createInsecure()
);
