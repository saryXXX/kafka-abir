...
import { saveOrder, getOrderById, getOrderItems, getOrdersByUserId, updateOrderStatus, updateOrderDriver } from './db.js';
dotenv.config();
...
// gRPC Handlers
const createOrderHandler = async (call, callback) => {
...
const getOrderHandler = (call, callback) => {
...
const getUserOrdersHandler = (call, callback) => {
