...
const deliveryProto = grpc.loadPackageDefinition(packageDefinition) as any;
...
// gRPC Handlers
const registerDriverHandler = (call: any, callback: any) => {
...
const getDriversHandler = (call: any, callback: any) => {
  try {
...
const updateDriverLocationHandler = (call: any, callback: any) => {
...
const getDeliveryStatusHandler = (call: any, callback: any) => {
